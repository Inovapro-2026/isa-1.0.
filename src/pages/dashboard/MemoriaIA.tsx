...
import { 
  Brain, Save, RotateCcw, Upload, Download, Eye, Send, Bot, 
  Building2, Clock, Package, FileText, MessageSquare, Lightbulb,
  Zap, Settings2, GraduationCap, Sparkles, Check, ChevronRight
} from "lucide-react";
  ...
  const fetchConfig = async () => {
    ...
    try {
      ...
      if (data) {
        ...
        // Parse knowledge base if exists
      ...
      <div className="p-6 lg:p-8 space-y-6">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
          <div>
            ...
            <p className="text-muted-foreground">Personalize o comportamento e conhecimento da IA</p>
          </div>
          ...
          <CardContent className="p-4">
            <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center">
              <div className="flex-1">
                <Label className="mb-2 block">Selecione a conta (CPF)</Label>
              ...
              <div className="flex items-center gap-2">
                <Switch
                  ...
                  id="apply-all"
                />
                <Label htmlFor="apply-all" className="text-sm">Aplicar para todas</Label>
              </div>
          ...
          <TabsContent value="knowledge" className="space-y-6">
            <Card className="glass">
              <CardHeader>
                ...
                <CardDescription>
                  Dados que a IA usará para responder sobre sua empresa
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    <Label>Valores</Label>
                    <Input
                      value={knowledge.company.values}
                      onChange={(e) => setKnowledge(prev => ({
                        ...prev,
                  ...
                  <div className="space-y-2">
                    <Label>Missão</Label>
                    <Input
                      value={knowledge.company.mission}
                      onChange={(e) => setKnowledge(prev => ({
                        ...prev,
            ...
            <Card className="glass">
              ...
              <CardContent className="space-y-4">
                <div className="grid md:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-2">
                    <Label>Comando para resumo</Label>
                    <Input
                      value={commands.summaryCommand}
                      onChange={(e) => setCommands(prev => ({ ...prev, summaryCommand: e.target.value }))}
                      placeholder="resumo hoje"
                    />
                  </div>
                  <div className="space-y-2">
                    <Label>Comando para estatísticas</Label>
                    <Input
                      value={commands.statsCommand}
                      onChange={(e) => setCommands(prev => ({ ...prev, statsCommand: e.target.value }))}
